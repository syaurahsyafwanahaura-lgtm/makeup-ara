...
<header>
  ...
  <div class="header-right">
    <div class="header-right">
  <div class="account" title="Akun" onclick="openAuthModal()">👤</div>
  <div class="cart" title="Keranjang" onclick="toggleCart()">🛒<span id="cartCount">0</span></div>
  <div class="chat" title="Chat Admin" onclick="openChatModal()">💬</div>
</div>
...
function autoReply(text){
  ...
  if(text.toLowerCase().includes("produk")){
    ...
    reply = "Pilih produk → Login → Tambah ke keranjang → Checkout.";
  }
